...
{
    Console.WriteLine("An error has occured, please re-sumbit your strength.");
    strength = Convert.ToInt32(Console.ReadLine());
};
bonusStrength = (strength - 10) / 2;
Console.WriteLine("Strength Bonus:");
Console.WriteLine(bonusStrength);
...
{
    Console.WriteLine("An error has occured, please re-submit your intelligence.");
    intelligence = Convert.ToInt32(Console.ReadLine());
};
bonusIntelligence = (intelligence - 10) / 2;
Console.WriteLine("Intelligence Bonus:");
Console.WriteLine(bonusIntelligence);
// Calculations.
